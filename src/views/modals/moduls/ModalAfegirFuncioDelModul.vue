<template>
  <Dialog v-model:visible="visible" modal @hide="hide" :closable="true" :closeOnEscape="false"
    :draggable="true" :header="$t('Moduls.Afegir Funcio del Modul')" style="width: 500px">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const guardar = async () => {
      ...
      await carrega(ModulsService.assignarFuncio( props.nomAplicacio, props.nomModul, request));
