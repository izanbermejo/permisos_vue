<template>
  ...
  <Dialog v-model:visible="visible" modal @hide="hide" :closable="true" :closeOnEscape="false"
    :draggable="false" :header="isEdicio ? $t('Comandes.Editar linia tarifa') : $t('Comandes.Afegir nova tarifa')" style="width: 600px">
    <div class="form" style="margin-top: 10px;">
      ...
      <div style="margin-left: auto; margin-right: 0; margin-top:10px">
        ...
        <ButtonShortcut @click="guarda" :literal="$t('App.Desa')" icon="fa-solid fa-save" :shortcut="'[Enter]'" style="margin-left: 10px;" type=""/>
      </div>
    </div>
  </Dialog>
</template>
...
import { calculaSeguentDiaLaborable } from '@/utils/dateUtils.js';
...
export default {
  name: "CrearEditarLiniaTarifaPeces",
