...
<div>
    <div :id="uniqueId" style="border: 0.25px solid #dbdbdb;">
        <DataTable :value="liniesEDI" class="p-datatable-sm-petita"
            ...
            <Column field="tipus" :header="$t('ComandesEDI.taula_comandesEDI.tipus')" :style="{width:'100%'}" style="max-width: 12%;">
              <template #body="{data}">
                {{ `${data.tipus}` }}
              </template>
            </Column>
            <Column field="datareg" :header="$t('ComandesEDI.taula_comandesEDI.data')" :style="{width:'100%'}" style="max-width: 18%;">
                <template #body="{data}">
            ...
            <Column field="articleClient" :header="$t('Comandes.Articleclient')" :style="{width:'100%'}" style="max-width: 20%;">
                <template #body="{data}">
            ...
            <Column field="numeroDocument" :header="$t('ComandesEDI.taula_comandesEDI.missatge')" :style="{width:'100%'}" style="max-width: 18%;">
                <template #body="{data}">
                  {{ data.numeroDocument }}
                </template>
            </Column>
